...
class UpdateCustomerRequest:
    ...
    Attributes:
        ...
        allowed_model_region (Union[None, Unset, UpdateCustomerRequestAllowedModelRegionType0]):
    ...
    allowed_model_region: Union[None, Unset, UpdateCustomerRequestAllowedModelRegionType0] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_allowed_model_region(
            data: object,
        ) -> Union[None, Unset, UpdateCustomerRequestAllowedModelRegionType0]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, UpdateCustomerRequestAllowedModelRegionType0], data)

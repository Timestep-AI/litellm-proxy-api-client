...
class NewOrganizationRequest:
    ...
    Attributes:
        ...
        model_max_budget (Union['NewOrganizationRequestModelMaxBudgetType0', None, Unset]):
    ...
    model_max_budget: Union["NewOrganizationRequestModelMaxBudgetType0", None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_model_max_budget(data: object) -> Union["NewOrganizationRequestModelMaxBudgetType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["NewOrganizationRequestModelMaxBudgetType0", None, Unset], data)
